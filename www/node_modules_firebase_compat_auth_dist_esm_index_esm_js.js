"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_firebase_compat_auth_dist_esm_index_esm_js"],{
...
function _isCordova2() {
  _isCordova2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    if (!_isLikelyCordova()) {
      return false;
    }
...
function _savePersistenceForRedirect2() {
  _savePersistenceForRedirect2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth) {
...
function _convertConfirmationResult() {
  _convertConfirmationResult = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, confirmationResultPromise) {
...
function _generateHandlerUrl2() {
  _generateHandlerUrl2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, event, provider) {
...
function _waitForAppResume2() {
  _waitForAppResume2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, eventListener, iabRef) {
    // Get the cordova plugins
    const {
      cordova
    } = _cordovaWindow();
...
function _computeSha() {
  _computeSha = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (sessionId) {
...
function _getAndRemoveEvent2() {
  _getAndRemoveEvent2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth) {
...
class CordovaPopupRedirectResolver {
  ...
  attachCallbackListeners(auth, manager) {
    ...
    const noEventTimeout = setTimeout( /*#__PURE__*/(0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const universalLinksCb = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (eventData) {
    ...
    _cordovaWindow().handleOpenURL = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_ludovic_Documents_Epsilon_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
